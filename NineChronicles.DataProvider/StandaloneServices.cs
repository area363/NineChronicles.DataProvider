...
namespace NineChronicles.DataProvider
{
    ...
    {
        public static DataProviderNodeService CreateHeadless(
        ...
        )
        {
            ...
            var service = new DataProviderNodeService(
        ...
        internal static void ConfigureStandaloneContext(this DataProviderNodeService service, StandaloneContext? standaloneContext)
        {
            if (!(standaloneContext is null))
            {
