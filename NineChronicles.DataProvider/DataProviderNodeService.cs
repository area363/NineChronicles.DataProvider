...
{
    public class DataProviderNodeService
    {
        ...
        public DataProviderNodeService(
        ...
        )
        {
            ...
            ActionRenderer.EveryRender<HackAndSlash4>().Subscribe(ev =>
                {
                    Console.WriteLine("*********** Action: " + ev.Action.PlainValue.ToString());
                }
            );
        }
